import 'package:idnstd/src/sky_cs/customer/data/models/sky_customer_biz_biz_all_order_model.dart';
import 'package:idnstd/src/sky_cs/customer/data/models/sky_customer_call_call_model.dart';
import 'package:idnstd/src/sky_cs/customer/data/models/sky_customer_cpn_campaign_customer_model.dart';
import 'package:idnstd/src/sky_cs/customer/data/models/sky_customer_et_ticket_model.dart';
...
class RT_SKY_CustomerAllDetailModel extends RT_SKY_CustomerAllDetail {
  ...
  factory RT_SKY_CustomerAllDetailModel.fromJson(Map<String, dynamic> json) {
