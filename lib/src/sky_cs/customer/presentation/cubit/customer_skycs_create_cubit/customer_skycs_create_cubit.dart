...
import 'package:idnstd/src/e_service/customer_manage/data/models/rq_es_customer_model.dart';
import 'package:idnstd/src/e_service/customer_manage/domain/usecases/get_customer_code_sys.dart';
import 'package:idnstd/src/sky_cs/customer/data/models/rq_sky_customer_model.dart';
...
import '../../../data/models/rt_sky_customer_type_model.dart';
import '../../../data/models/sky_customer_column_model.dart';
import '../../../data/models/sky_customer_group_model.dart';
import '../../../data/models/sky_customer_partner_type_model.dart';
import '../../../data/models/sky_customer_type_model.dart';
import '../../../data/models/sky_customer_zalo_user_model.dart';
import '../../../data/models/sky_option_value_model.dart';
...
class CustomerSkyCSCreateCubit extends Cubit<CustomerSkyCSCreateState> {
  ...
  Future<void> init() async {
    ...
    try {
      ...
      print("CHECK CODE sys ${resultFold}");
      ...
      // check API
       final customerType = await _getAllCustomerTypeUseCase.call(GetAllCustomerTypeParams());
      ...
      // print("TrungLQ: ${listcustomerTypeFold}");
      // print("TrungLQ 2: ${listcustomerPartnerTypeFold}");
      // print("TrungLQ 3: ${listzaloUserFold}");
