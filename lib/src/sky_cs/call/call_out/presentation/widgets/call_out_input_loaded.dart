...
class CallOutInputLoadedView extends StatefulWidget {
  const CallOutInputLoadedView({
    super.key,
  });

  @override
  State<CallOutInputLoadedView> createState() => _CallOutInputLoadedViewState();
}

class _CallOutInputLoadedViewState extends State<CallOutInputLoadedView> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<CallOutCubit, CallOutState>(
      builder: (context, state) {
        state as CallOutInputLoaded;
        return Column(
          children: [
            ...
            GridView.count(
              ...
              children: List.generate(15, (index) {
                if (index < 12) {
                  ...
                  return InkWell(
                    onTap: () {
                      context.read<CallOutCubit>().call(dropdownValue, state.phoneNumber);
                    },
                    highlightColor: Colors.transparent,
                    splashColor: Colors.transparent,
                    child: Container(
  ...
  Widget _phoneArea(CallOutInputLoaded state) {
