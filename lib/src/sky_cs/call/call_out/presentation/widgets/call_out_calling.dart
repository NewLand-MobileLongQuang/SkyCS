...
class CallOutCallingView extends StatefulWidget {
  const CallOutCallingView({super.key});

  @override
  State<CallOutCallingView> createState() => _CallOutCallingViewState();
}

class _CallOutCallingViewState extends State<CallOutCallingView> {
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<CallOutCubit, CallOutState>(
      builder: (context, state) {
        state as CallOutCalling;
