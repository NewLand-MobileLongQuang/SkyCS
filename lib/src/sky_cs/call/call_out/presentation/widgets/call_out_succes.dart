...
class CallOutCallSuccessView extends StatefulWidget {
  const CallOutCallSuccessView({super.key});

  @override
  State<CallOutCallSuccessView> createState() => _CallOutCallSuccessViewState();
}

class _CallOutCallSuccessViewState extends State<CallOutCallSuccessView> {
